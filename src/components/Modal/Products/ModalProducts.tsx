...
export interface ModalProductsProps extends IModalDefaultProps {
...
const ModalProducts: FC<ModalProductsProps> = ({
  isShow,
  setIsShow,
  currentData,
  onSuccess
  ...
  return (
    <Modal show={isShow} onClose={handleClose}>
      <Modal.Header>{currentData ? "Chỉnh sửa" : "Thêm"} sản phẩm</Modal.Header>
      <Modal.Body>
